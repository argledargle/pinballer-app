  ...
  handleSubmitJwtAuth = ev => {
    ...
    AuthApiService.postLogin({
      ...
      .then(res => {
        ...
        console.log(`res.dbUser.pinballer_user_id`, res.dbUser.pinballer_user_id)
        this.setState({
          user: res.dbUser
        })
        username.value = "";
      ...
      <div>
        ...
        <section>
          <form onSubmit={this.handleSubmitJwtAuth} className="signin-form">
            <div>
              <label htmlFor="username" className="hide-element">Nick name</label>
              <input type="text" name="username" id="username" placeholder="Nickname"/>
            </div>
            <div>
              <label htmlFor="password" className="hide-element">Password</label>
